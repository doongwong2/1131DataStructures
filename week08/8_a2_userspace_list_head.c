...
void list_print(struct list_head*);
...
void list_print(struct list_head* head)
{
    ...
    // Iterate over the list starting from the head's next element
    list_for_each(pos, head) {
        // Get the node associated with the current list head
        node_t* node = list_entry(pos, node_t, ptr);
        printf("%d -> ", node->val); // Print the value of the node
    }
    printf("NULL");

    printf("\n"); // Print a newline after listing all values
}
